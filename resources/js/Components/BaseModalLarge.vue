<template>
  <div class="fixed z-101 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" @click="$emit('hideModal')">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left max-h-screen overflow-y-auto shadow-xl transform transition-all sm:my-4 sm:align-middle sm:max-w-7xl sm:w-full" @click.stop="" >
