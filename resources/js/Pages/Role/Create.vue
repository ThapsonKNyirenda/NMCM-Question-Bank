        ...
        <template #header>
            <div class="w-full">
                <wizard>
                    ...
                    <wizard-step data-wizard-state="pending" wizard-number="2" href="#" >Role Permissions</wizard-step>
                </wizard>
            </div>
...
<!--        <div class="separator separator-dashed mb-5"></div>-->
        <form method="POST" :action="route('roles.store')" novalidate class="needs-validation w-3/4 mx-auto" @submit.prevent.stop="submit(inertiaSubmit, 'add the role?')" >
            ...
            />
            <base-button-submit class="btn-light-primary" type="submit" :form-is-processing="form.processing" >Add Role & Continue</base-button-submit>
        </form>
    </base-card-main>
